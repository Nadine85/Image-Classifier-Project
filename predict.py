...
def parse_arguments():
    ...
    parser.add_argument('--image', default="image.jpg", help='image file must be provided for classification')
    parser.add_argument('--checkpoint', default= "checkpoint.pth", help='trained network  must be provided for classification')
    parser.add_argument('--top_k', default =5, type=int, help='number of most probable categories [default = 5].')
